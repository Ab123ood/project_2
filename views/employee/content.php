    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
      <div class="card card-gradient-primary animate-fade-in">
        <div class="card-body">
          ...
          <div class="text-base text-gray-600"><?= __('employee.content.available_content') ?></div>
        </div>
      </div>
      <div class="card card-gradient-success animate-fade-in animate-delay-100">
        <div class="card-body">
          ...
          <div class="text-base text-gray-600"><?= __('employee.content.viewed_content') ?></div>
        </div>
      </div>
      <div class="card card-gradient-warning animate-fade-in animate-delay-200">
        <div class="card-body">
          ...
          <div class="text-base text-gray-600"><?= __('employee.content.favorited_content') ?></div>        </div>
      </div>
      <div class="card card-gradient-secondary animate-fade-in animate-delay-300">
        <div class="card-body">
          ...
          <div class="text-base text-gray-600"><?= __('employee.content.earned_points') ?></div>
        </div>
      </div>
    </div>
