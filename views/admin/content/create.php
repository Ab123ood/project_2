...
<div class="bg-white shadow-sm border border-gray-200 rounded-xl mb-6">
  <div class="px-6 py-4 flex items-center justify-between">
    <div class="flex items-center">
      ...
      <div>
        <h1 class="text-xl md:text-2xl font-bold text-gray-900"><?= __('admin.content.create_title') ?></h1>
        <p class="text-sm text-gray-600"><?= __('admin.content.create_desc') ?></p>
      </div>
    </div>
    <a href="<?= $basePath ?>/admin/content" class="px-4 py-2 border border-gray-300 rounded-lg text-sm text-gray-700 hover:bg-gray-50"><?= __('admin.content.back') ?></a>
  </div>
</div>
