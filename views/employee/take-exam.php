            ...
            <div class="flex-1">
                ...
                <div class="flex items-center gap-6 mt-4 text-sm">
                    <div class="flex items-center">
                        ...
                        <span><?= count($questions) ?> <?= count($questions) == 1 ? __('employee.exams.question') : __('employee.exams.questions') ?></span>
                    </div>
                    <div class="flex items-center">
                        <i class="ri-star-line ml-2"></i>
                        <span><?= $exam['total_points'] ?? (count($questions) * 10) ?> <?= __('employee.exams.points') ?></span>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
                <div class="bg-white/20 backdrop-blur-sm rounded-2xl p-6 text-center">
                    <div class="text-sm font-medium mb-2"><?= __('employee.exams.remaining_time') ?></div>
