  ...
  <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex items-center justify-between">
          <div>
            <div class="flex items-center gap-3 mb-4">
              ...
              <h1 class="text-3xl font-bold"><?= __('employee.surveys.title') ?></h1>
            </div>
            <p class="text-green-100 text-lg"><?= __('employee.surveys.subtitle') ?></p>
          </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="text-sm text-gray-500"><?= __('employee.surveys.completed_surveys') ?></div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="text-sm text-gray-500"><?= __('employee.surveys.average_rating') ?></div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="text-sm text-gray-500"><?= __('employee.surveys.available_surveys') ?></div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="text-sm text-gray-500"><?= __('employee.surveys.earned_points') ?></div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
      <h3 class="text-lg font-bold text-gray-900 mb-4 flex items-center">
        ...
        <?= __('employee.surveys.filter_title') ?>
      </h3>
      <div class="grid md:grid-cols-3 gap-4">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2"><?= __('common.search') ?></label>
          <div class="relative">
            <input type="text" id="searchInput" placeholder="<?= __('employee.surveys.search_placeholder') ?>" 
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2"><?= __('employee.surveys.type_label') ?></label>
