...
<?php
// تحديد المسار الحالي والدور النشط لتحديد متى يتم عرض الشريط الجانبي للإدارة
...
// خريطة الأدوار: 1 = موظف، 2 = مسؤول توعية، 3 = مدير
$roleId = (int)($_SESSION['role_id'] ?? 0);

// عرض الشريط الجانبي لجميع مسارات /admin وفي /dashboard للأدوار المميزة
...
<body class="bg-gray-50 min-h-screen<?= $isRtlLayout ? ' rtl' : '' ?>">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            <!-- إخفاء رأس وذيل التسويق للواجهات الإدارية -->
