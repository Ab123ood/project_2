...
<div class="flex items-center justify-between mb-6">
    <h2 class="text-xl md:text-2xl font-bold text-gray-900"><?= __('admin.exams.create_title') ?></h2>
    <a href="<?= $basePath ?>/admin/exams" class="text-sm text-gray-600 hover:text-gray-900"><?= __('admin.exams.back_to_list') ?></a>
</div>
...
<form method="post" action="<?= $basePath ?>/admin/exams" id="examForm" class="max-w-5xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        <div class="flex items-center mb-6">
            ...
            <h2 class="text-lg font-medium text-gray-900"><?= __('admin.exams.basic_info') ?></h2>
        </div>
